      ...
      <div className="relative z-10 w-full max-w-[400px] flex flex-col items-center">
          ...
          <form className="p-6 space-y-6 text-left" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
              ...
              <div className={`flex items-center border-2 transition-colors duration-200 rounded-none ${
                focusedField === 'email' ? 'border-[#1B79EE]' : 'border-[#004aad]'
              }`}>
            ...
            <div className="space-y-1.5">
              ...
              <div className={`flex items-center border-2 transition-colors duration-200 rounded-none ${
                focusedField === 'password' ? 'border-[#1B79EE]' : 'border-[#004aad]'
              }`}>
                <div className="p-3 border-r-2 border-[#004aad] bg-white rounded-none">
        ...
        <div className="mt-6 text-center">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider rounded-none">
            ...
            <button type="button" className="text-[#1B79EE] font-black underline hover:text-[#004aad] uppercase">
