...
export default function RegionalReadyMixGrid() {
  const initialProducers: ReadyMixNode[] = [
    { rank: "01", name: "Cemex USA", region: "USA", fleetCapacity: "Massive Logistics Fleet Array", status: "VERIFIED SUPPLY NODE" },
    { rank: "02", name: "CRH Americas Materials", region: "USA", fleetCapacity: "High-Volume Infrastructure Plant Network", status: "VERIFIED SUPPLY NODE" },
    { 
      rank: "03", 
    ...
    { rank: "04", name: "Martin Marietta Materials", region: "USA", fleetCapacity: "Heavy Industrial High-Pour Logistics", status: "VERIFIED SUPPLY NODE" },
    { rank: "05", name: "Lafarge Canada Inc.", region: "CANADA", fleetCapacity: "Cross-Provincial Multi-Silo Logistics", status: "VERIFIED SUPPLY NODE" },
    { rank: "06", name: "Lehigh Hanson Canada", region: "CANADA", fleetCapacity: "ECO-Pour Low Carbon Distribution Trucks", status: "VERIFIED SUPPLY NODE" },
    { rank: "07", name: "St Marys Cement", region: "CANADA", fleetCapacity: "High-Output Urban Batch Matrix", status: "VERIFIED SUPPLY NODE" },
    { rank: "08", name: "Canada Building Materials (CBM)", region: "CANADA", fleetCapacity: "Automated Precision Volumetric Dispatch", status: "VERIFIED SUPPLY NODE" },
    { rank: "09", name: "Carib Cement (Rockfort Foundry)", region: "CARIBBEAN", fleetCapacity: "Coastal Infrastructure Transport Network", status: "VERIFIED SUPPLY NODE" },
    { rank: "10", name: "Pre-Mix Jamaica Limited", region: "CARIBBEAN", fleetCapacity: "Specialized High-Heat Pumping Logistics", status: "VERIFIED SUPPLY NODE" },
    { rank: "11", name: "Heidelberg Materials Europe", region: "EUROPE", fleetCapacity: "Continental High-Output Production Hubs", status: "VERIFIED SUPPLY NODE" },
      ...
      <div className="w-full border-b-2 border-[#004aad] pb-6 mb-10 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 rounded-none">
        <div>
          ...
          <h2 className="text-3xl font-black text-[#004aad] tracking-tight uppercase mt-1 rounded-none">
            TOP TWELVE <span className="text-[#1B79EE]">READY MIX PRODUCERS BY REGION</span>
          </h2>
        </div>
